// xml2html.js
// Time-stamp: "2019-04-12 14:12:22 queinnec"

module.exports = function (CodeGradX) {
    const _ = CodeGradX._;

    // Module sax is needed here but also by xml2js
    const sax = require('sax');

    // ****************************** he inlining **********************
    // xml2html is the only module that requires he, so inline he here!
    //const he = require('he');
    (function () {
        let global = {};
...
/** QNC useless since only needed by decode:
...
/*QNC decode is useless for this module:
